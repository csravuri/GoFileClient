...
namespace GoFileClient.Common
{
	...
	{
		private static readonly Dictionary<int, GoFileUploadManager> AllManagers = new Dictionary<int, GoFileUploadManager>();
		private bool isBusy = false;
		private readonly UploadHeaderEntity header;
		private readonly DbConnection DBConnection = DbConnection.GetDbConnection();
