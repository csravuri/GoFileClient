...
namespace GoFileClient.Database
{
	...
	public class DbConnection
	{
		...
		private readonly List<UploadHeaderEntity> uploadHeadersCache = new List<UploadHeaderEntity>();
		private readonly List<UploadLineEntity> uploadLinessCache = new List<UploadLineEntity>();
